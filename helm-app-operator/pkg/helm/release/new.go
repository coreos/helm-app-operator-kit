...
// NewManagerFactory returns a new Helm manager capable of installing and uninstalling releases.
...
// newManagerFactoryFromEnv returns a GVK and manager based on configuration provided
// in the environment.
